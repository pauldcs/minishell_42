...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ms_syner_state_cmd_iords.c                         :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: nmathieu <nmathieu@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/09 23:08:06 by nmathieu          #+#    #+#             */
/*   Updated: 2022/07/04 12:18:12 by nmathieu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_ms_syn_r	ms_syner_state_cmd_basic(
						t_ms_syner *self,
						t_ms_tok *token,
						t_ms_syn *result,
						t_ms_iord_kind kind)
...
t_ms_syn_r	ms_syner_state_cmd_write(
				...
				t_ms_syn *result)
{
	return (ms_syner_state_cmd_basic(self, token, result, MS_IORD_WRITE));
}
...
t_ms_syn_r	ms_syner_state_cmd_append(
				...
				t_ms_syn *result)
{
	return (ms_syner_state_cmd_basic(self, token, result, MS_IORD_APPEND));
}
...
t_ms_syn_r	ms_syner_state_cmd_read(
				...
				t_ms_syn *result)
{
	return (ms_syner_state_cmd_basic(self, token, result, MS_IORD_READ));
}
